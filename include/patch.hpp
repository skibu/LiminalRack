...
class Manager {
   private:
    // Manager::Internal currently has no members
    struct Internal;
    Internal* internal_;
    ...
    */
    ...
    /** Checks if the JSON patch object contains modules not found in the loaded
    plugins, and launches a dialog box asking the user to cancel loading.
