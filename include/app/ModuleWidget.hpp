...
struct ModuleWidget : widget::OpaqueWidget {
   ...
   public:
    ...
    /** Returns Module attached to this ModuleWidget, casted to the given Module
     * type. */
    ...
    */
    ...
    It is not required to call this method. You may instead use addChild() in a
    child widget for example.
    */
    void addParam(ParamWidget* param);
    void addInput(PortWidget* input);
    void addOutput(PortWidget* output);
    /** Scans children widgets recursively for a ParamWidget with the given
     * paramId. */
    ...
    */
    void resetAction();
    /** Randomizes the parameters of the module and calls the Module's
    randomize(). Called when the user clicks Randomize in the context menu.
    */
