...
struct SvgSwitch : Switch {
   private:
    // SvgSwitch::Internal not currently used. Just a placeholder.
    struct Internal;
    Internal* internal_;
   ...
   public:
    ...
    /** Use frames 0 and 1 when the mouse is pressed and released, instead of
     * using the param value as the frame index.
     */
    bool latch = false;
