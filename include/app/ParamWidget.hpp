...
struct ParamWidget : widget::OpaqueWidget {
   ...
   public:
    ...
    This seems a bit hacky, but it's easier than requiring plugin developers to
    set `ParamQuantity::randomizeEnabled`, etc.
    */
    ...
    /** Override to add custom menu items at the bottom of the parameter context
    menu. It is recommended to add a MenuSeparator before other menu items.
