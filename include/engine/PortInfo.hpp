...
struct PortInfo {
    ...
    Since this text is often prepended or appended to the name, the name will appear as e.g. "Sine
    input input", "Input: Sine input".
    */
    std::string name;
    ...
    /** Returns the module associated with the port */
